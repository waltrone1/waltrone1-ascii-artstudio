...
set "APP_NAME=waltrone1-ASCII-ArtStudio"
set "ICON_FILE=%PROJECT_DIR%\waltrone1-ASCII-ArtStudio.ico"
set "VERSION_FILE=%PROJECT_DIR%\version_info.txt"
set "ENTRY_FILE=%PROJECT_DIR%\run.py"
set "SPEC_FILE=%PY2EXE_DIR%\waltrone1-ASCII-ArtStudio.spec"
...
if not exist "%ICON_FILE%" (
    ...
    echo %PROJECT_DIR%\waltrone1-ASCII-ArtStudio.ico
    pause
    exit /b 1
)
